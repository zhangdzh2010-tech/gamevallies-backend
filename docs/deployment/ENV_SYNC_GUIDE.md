...
| 对外域名与内部 upstream | `PUBLIC_API_BASE_URL`、`USER_SERVICE_URL`、`GAME_SERVICE_URL`、`FEED_SERVICE_URL`、`AI_ENGINE_URL_CN_SHANGHAI`、`AI_ENGINE_URL`、`GAME_SERVICE_UPSTREAM_URL`、`FEED_SERVICE_UPSTREAM_URL` | 当前生产 `.env.deploy` + APIG 控制台 |
