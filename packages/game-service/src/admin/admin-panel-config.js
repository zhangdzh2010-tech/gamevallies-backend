...
const TIMEOUT_FLOW_SECTION_FALLBACKS = {
  ...
  extra_tools: { id: 'extra_tools', kind: 'extra', order: 70, tag: 'Extra', title: 'Auxiliary Tools', description: 'Prompt expansion and other sidecar tools.', color: '#475569', bg: '#f8fafc', border: '#cbd5e1' },
