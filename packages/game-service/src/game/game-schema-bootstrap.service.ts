...
const TABLE_COLUMN_PATCHES: ColumnPatch[] = [
  ...
  },
  {
    ...
    name: "region_hint",
    sql: "ALTER TABLE game_creation_sessions ADD COLUMN region_hint VARCHAR(32) NULL AFTER title_draft",
  },
  {
    table: "game_creation_sessions",
    name: "locale",
    sql: "ALTER TABLE game_creation_sessions ADD COLUMN locale VARCHAR(16) NULL AFTER region_hint",
  },
  {
    table: "game_creation_sessions",
    name: "ai_state",
    sql: "ALTER TABLE game_creation_sessions ADD COLUMN ai_state VARCHAR(32) NULL AFTER locale",
  },
  {
    table: "game_creation_sessions",
    name: "questions_asked",
    sql: "ALTER TABLE game_creation_sessions ADD COLUMN questions_asked INT NOT NULL DEFAULT 0 AFTER question_budget",
  },
  {
    table: "game_creation_sessions",
    name: "expires_at",
    sql: "ALTER TABLE game_creation_sessions ADD COLUMN expires_at DATETIME(3) NULL AFTER questions_asked",
  },
  {
    table: "game_creation_sessions",
    name: "last_client_request_id",
    sql: "ALTER TABLE game_creation_sessions ADD COLUMN last_client_request_id VARCHAR(64) NULL AFTER expires_at",
  },
  {
    table: "game_creation_sessions",
    name: "last_client_message_id",
    sql: "ALTER TABLE game_creation_sessions ADD COLUMN last_client_message_id VARCHAR(64) NULL AFTER last_client_request_id",
  },
  {
    table: "game_creation_sessions",
    name: "last_generate_key",
    sql: "ALTER TABLE game_creation_sessions ADD COLUMN last_generate_key VARCHAR(64) NULL AFTER last_client_message_id",
  },
  {
    table: "llm_call_logs",
    name: "input_tokens",
