...
LLM_ROUTING_POLICY = {'version': 1,
 'legacyUncheckedFlags': {'verified': False,
 ...
 'stages': [{'id': 'generate',
            ...
            {'id': 'assist',
             ...
             'stepKeys': ['intent_parse', 'creative_anchors', 'code_review']}],
 'stepCapabilities': {'creative_anchors': ['supports_dialogue'],
