...
{"issue":"same defect string", "dimension":"one boolean or score field",
 "code_excerpt":"short exact contiguous source excerpt, no ellipses",
...
Each excerpt must occur in the supplied HTML exactly once and be at most 1200
characters. Include enough context to identify the location. A local finding
